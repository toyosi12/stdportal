...
<body>
	<div class="container-fluid">
		...
		<h3 class="text-center" style="color:#008000;">Payment History</h3>		 
			<span class="help-block text-center">History of your invoices and payments (Double Click on an invoice number to make payment.)<br /> 
			</span>
				  <div class="controls">
					<?php 
                  ...
                  <table class="table table-bordered"><tr><th width="5%">#</th><th>Amount</th><th>Amount Due</th><th>Due Date</th><th>Status</th><th>Print/View</th></tr>
			...
			if(!$sql)
			{
				   echo "<tr><td colspan=6 align=center>No Invoices yet</td></tr>"; 
